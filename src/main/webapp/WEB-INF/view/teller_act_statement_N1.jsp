...
function validateForm() {
	let val = document.forms["statementForm"]["num"].value;
	errorExists = false;
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<title>Account Transaction Management Area</title>
</head>
<body>
	...
	<div class="main-content">
		<h2 class="page-title">Account Statement Management</h2><h2 class="page-title">Last N Transactions</h2>
		<br>
		<form action='searchTxTellerNType.html' name="statementForm" onsubmit="return validateForm()">
			<table class="table-create">
				<tr>
					<td>Account ID: </td>
					<td><input type='text' name='accId' value='${accId}' readonly></td>
				</tr>
				<tr>
		...
		<c:if test="${not empty test}">
			<table class="table-default">
				...
				<c:forEach var="listItem" items="${li}">
				<tr>
					<td>${listItem.transactionId}</td>
					<td>${listItem.transactionType}</td>
					<td>${listItem.transactionDate}</td>
					<td>${listItem.transactionAmount}</td>
				</tr>
				</c:forEach>
			</table>
			<div class="downlaods">
				<a href="downloadPdf.html"><button class="download-button">Download PDF File</button></a>
				<a href="downloadCsv.html"><button class="download-button">Download CSV File</button></a>
				<a href="downloadXlsx.html"><button class="download-button">Download XLSX File</button></a>
			</div>
		</c:if>
	</div>
