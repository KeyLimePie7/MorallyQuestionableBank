...
<div class="main-content">
	<h1 class="page-title" align="center">Executive Home Page</h1>
	
					<td><a href="searchLoad.html">Search for Customer</a></td>
					<td><a href="list.html">List of Customers</a></td>
					<td><a href="allacclist.html">List of Accounts</a></td>
