...
function validateForm() {
	let val = document.forms["depositForm"]["depositAmount"].value;
	errorExists = false;
	...
	if (!errorExists) {
		if (isNaN(val)) {
			...
			alert("Deposit amount must be a number greater than zero!");
			errorExists = true;
		}
	}
...
<body>
	...
	<h1 class="page-title" align="center">Deposit Money</h1>
		<form class="form" name="depositForm" action="deposit-submit.html" style="width:70%" onsubmit="return validateForm()">
			<table class="table-create">
				<tr>
					<td>Customer ID : ${account.customerId }</td> 
				</tr>
				<tr>
					<td>Account ID : ${account.accountId }</td>
				</tr>
				<tr>
				...
				<tr>
					<td>Deposit Amount : <input type="text" name="depositAmount" /></td>
				</tr>
				<tr><td><input type="hidden" name="accountId" value="${account.accountId }" /></td></tr>
				<tr>
					<td><input class="submit-button" type='submit' name='submit' value='Submit'></td>
				</tr>
