...
<body>
	...
	<div class="main-content">
		<h1 class= "page-title" align="center">Customer Accounts</h1>
		<c:if test="${not empty acc}">
			<table border="0" align="center" width="30%">
				<tr> 
					...
					<td>
						<select name="acc" id="acc" onchange="location=this.options[this.selectedIndex].value;">
							<option value="">Select Account</option>
							<c:forEach var="i" items="${acc}">
								<option value="findAcc.html?accountId=${i.accountId}&search=Search">
									${i.accountId} ${i.accountType}</option>		
							</c:forEach>
						</select>
					</td>
				</tr>
		...
		<c:if test="${empty acc}">
			<p align="center"><font color="red">No such customer!</font></p>
		</c:if>
		<p align="center">
		</p>
	</div>
