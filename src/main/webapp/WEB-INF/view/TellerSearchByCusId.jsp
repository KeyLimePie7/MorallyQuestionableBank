...
<script language="javascript">
    function validate() {
        var aId = document.getElementById("customerId").value;
        document.getElementById("err1").innerHTML = "";
        taId = aId.trim();
        if (taId.length > 0) {
            if (isNaN(taId)) {
                document.getElementById("err1").innerHTML = "Not a valid Customer ID";
                return false;
            } else {
            return true;
            }        
        } else {
            document.getElementById("err1").innerHTML = "Customer ID required";
            return false;
            }
    }
    ...
    function validate1() {
        ...
        if (taId.length > 0) {
            if (isNaN(taId)) {
                document.getElementById("err2").innerHTML = "Not a valid Account ID";
                return false;
            } else {
            return true;
            }        
        } else {
            document.getElementById("err2").innerHTML = "Account ID required";
            return false;
            }
    }
</script>
...
<body>
	...
	<div class="main-content">
		...
		<div>
			<form name="searchByCusForm" method="get" action="listAcc.html" onsubmit="return validate()" align="center">
				<table border="0" align="center" width="100%">
					<tr>
						<td class="padded">Customer Id</td>
						<td><input type="text" name="customerId" id="customerId"></td>
						<SPAN style="color:red" id="err1"></SPAN>
					</tr>
					<tr>
						<td></td>
						<td align="center"><input class="button" type="submit" value="Search"></td>
					</tr>
				</table>
			</form>
			<br><h5 align="center" style="font-weight: 600;">OR</h5>
			<form name="searchByAccForm" method="get" action="findAcc.html" onsubmit="return validate1()" align="center">
				<table border="0" align="center" width="100%">
					<tr>
						<td class="padded">Account Id</td>
