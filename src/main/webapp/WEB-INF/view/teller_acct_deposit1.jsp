...
function validateForm() {
	let val = document.forms["transferForm"]["amount"].value;
	errorExists = false;
	...
	if (!errorExists) {
		if (isNaN(val)) {
			...
			alert("Transfer amount must be a number greater than zero!");
			errorExists = true;
		}
	}
...
<body>
	...
	<div class="main-content">
		<h1 class="page-title" align="center">Transfer Money</h1>
		<form class="form" action="transferFunds2.html" style="width:70%" name="transferForm" onsubmit="return validateForm()">
		
			<table class="table-create">
				<tr>
					<td>Customer ID: </td>
					<td><input type='text' name='custId' value='${custId1}' readonly></td>
				</tr>
				<tr>
					<td>Source Account Type: </td>
				...
				<tr>
					<td colspan='2'><input class="submit-button" type='submit' name='submit' value='Transfer'></td>
				</tr>
			</table>
		</form>
	</div>
