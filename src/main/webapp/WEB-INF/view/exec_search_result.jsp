...
<body>
	...
	<div class="main-content">
		<h1 class="page-title" align="center">Customer Status</h1>
		<c:if test="${not empty customer}">
			<table class="table-default" border="1" align="center" width="80%">
				<tr>
					<th>Customer Id</th>
					<th>Customer SSN</th>
					<th>Customer Name</th>
				...
				<tr>
					...
					<td>${customer.age}</td> 
					<td><a href="execviewacc.html?customerId=${customer.customerId}">View Account</a></td>
					<td><a href="updateCustomer.html?customerId=${customer.customerId}">Update Customer</a></td>
					<td>
						<c:if test="${boolList[0] }">
							<a href="delete-customer.html?customerId=${customer.customerId}" onclick="return confirm('Do you want to delete?')">Delete Customer</a>
						</c:if>
						<c:if test="${not boolList[0] }">
		...
		<c:if test="${empty customer}">
			<p><font color="red">No customer found!!!</font></p>
			<p><a href="searchLoad.html">Search again?</a></p>
		</c:if>
		
		<p><a href="create-customer-page.html"><button class="submit-button">Create new customer</button></a></p>
	</div>
