...
<body>
	...
	<div class="main-content">
		<h2 class="page-title">Account Statement Management</h2>
		<form action='searchTxTeller2.html' onsubmit="return validateRadio()">
		<table class="table-create">
			...
			<tr>
				<td colspan='2'>Method to retrieve transaction history:</td>
			</tr>
			<tr>
				<td colspan='2'>
				<input type="radio" name="methodType" value="lastN" id="radio1">
	 			<label for="lastN">Last Number of Transactions</label>
				</td>
			</tr>
			<tr>
				<td colspan='2'>
				<input type="radio" name="methodType" value="date" id="radio2">
	 			<label for="date">Start-End Dates</label>
				</td>
			</tr>
			<tr>
