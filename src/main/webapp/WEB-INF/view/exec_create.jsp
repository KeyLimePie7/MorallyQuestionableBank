...
function validateForm() {
	let bal = document.forms["createForm"]["balance"].value;
	errorExists = false;
...
<body>
	...
	<div class="main-content">
		<h2 class="page-title"align="center">Create Customer Account</h2>
		<form class="form" name="createForm" method="get" onsubmit="return validateForm()" action="exec_create_submit.html" style="width:60%;">
			<table class="table-create" border="0" align="center">
				<tr>
					<td>
						<p>Customer Id: <span style="color:red;"> *</span></p>
					</td>
					<td>
				...
				<tr>	
					...
					<td>
	  					<select name="accountType" id="acc">
	  					<c:if test="${numAccs==0 }">
				...
				<tr>
					<td>
						<p>Deposit Amount: <span style="color:red;"> *</span></p>
					</td>
					<td>
				...
				<tr>
					<td><p style="color:red;">(*)Fields are compulsory</p></td>
				</tr>
				<tr>
					<td></td>
