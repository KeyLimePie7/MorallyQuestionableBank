...
<body>
	...
	<div class="main-content">
		<h2>Account Delete Result</h2>
		<table border="0" align="center" width="35%">
			<tr>
				<td align="center">
					<c:if test="${lmao == 1}">
						<font color="black">Account deleted successfully.</font>
					</c:if>
					<c:if test="${lmao == 0}">
						<font color="red">Error! Unable to delete account</font>
					</c:if>
				</td>
			</tr>
		</table>
		<p align="center">
			<a href="exec-splash.html">Back</a>
		</p>
	</div>
