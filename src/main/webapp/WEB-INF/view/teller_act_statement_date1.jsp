...
<body>
	...
	<div class="main-content">
		<h2 class="page-title">Account Statement Management</h2><h2 class="page-title">Date</h2>
		<form action='searchTxTellerDate.html' name="statementForm" onsubmit="return validateForm()">
		...
		<c:if test="${not empty tester}">
			<table class="table-default">
				...
				<c:forEach var="listItem" items="${arr}">
				<tr>
