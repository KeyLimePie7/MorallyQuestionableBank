...
<div class="main-content">
	<h1 class="page-title" align="center">Account Status</h1>
	<c:if test="${not empty accList}">
		<table class="table-default" border="1" align="center" width="80%">
			...
			<c:forEach var="acc" items="${accList}">
				<tr align="center">
					<td><p>${acc.accountId}</p></td>
					<td><p>${acc.customerId}</p></td>
					<td><p>${acc.accountType}</p></td>
					<td><p>${acc.balance}</p></td>
					<td><p>${acc.creationDate}</p></td>
					<td>
					...
					<td><a href="search.html?custId=${acc.customerId}&ssnId=">View Customer</a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
