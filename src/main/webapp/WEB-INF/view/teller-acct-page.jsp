		...
		<c:if test="${not empty account}">
				<table border="1" align="center" width="80%">
					...
					<tr>
						...
						<td><a href="deposit.html?acctId=${account.accountId}">Deposit</a></td>
						<td><a href="accountWithdraw.html?AccId=${account.accountId}">Withdraw</a></td>
						<td><a href="transferFunds.html?customerId=${account.customerId}">Transfer</a></td>
						<td><a>Statement</a></td>
					</tr>
				</table>
		</c:if>
