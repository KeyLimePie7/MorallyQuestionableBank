...
<div class="main-content">
	<h2 class="page-title"align="center">Teller Home</h2>
	<form class="form" name="searchForm" method="get" action="teller-search-main.html">
		...
		<br>
			<c:if test="${emptyInput == true }">
				<p style="color:red;">Please enter fields</p>
			</c:if>
		<input class="button" type="submit" name="search" value="VIEW">
	</form>
