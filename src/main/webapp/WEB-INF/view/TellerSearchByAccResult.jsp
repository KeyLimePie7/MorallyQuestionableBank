...
<body>
	...
	<div class="main-content">
		<h1 class="page-title" align="center">Account Details</h1>
		<c:if test="${not empty Account}">
			<table class="table-create" border="1" align="center" width="40%">
				<tr>
					<td class="colon-end">Customer Id</td>
					<td>${Account.customerId}</td>
				</tr>
				<tr>
					<td class="colon-end">Account ID</td>
					<td>${Account.accountId}</td>
				</tr>
				<tr>
					<td class="colon-end">Account Type</td>
					<td>${Account.accountType}</td>
				</tr>
				<tr>
					<td class="colon-end">Balance</td>
			...
			<!--  NEW TESTING SHIT -->
			<div class="actions">
				<a href="deposit.html?acctId=${Account.accountId}"><button>Deposit</button></a>
				<a href="accountWithdraw.html?AccId=${Account.accountId}"><button>Withdraw</button></a>
				<a href="transferFunds.html?customerId=${Account.customerId}"><button>Transfer</button></a>
				<a href='searchTxTeller.html?accountId=${Account.accountId}'><button>Statement</button></a>
			</div>
		...
		<c:if test="${empty Account}">
			<p align="center">
				<font color="red">No such customer!</font>
			</p>
		</c:if>
	</div>
